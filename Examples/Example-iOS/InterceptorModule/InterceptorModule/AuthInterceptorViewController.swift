...
class AuthInterceptorViewController: UIViewController, Routable {
    ...
    @objc private func testPublicRouteTapped() {
        ...
        // 使用RouterKit导航到公开路由
        Router.shared.navigate(to: "/InterceptorModule/public", parameters: [
            "testType": "public",
    ...
    @objc private func testPrivateRouteTapped() {
        ...
        Router.shared.navigate(to: "/InterceptorModule/private", parameters: [
            "testType": "private",
    ...
    @objc private func testAdminRouteTapped() {
        ...
        Router.shared.navigate(to: "/InterceptorModule/admin", parameters: [
            "testType": "admin",
