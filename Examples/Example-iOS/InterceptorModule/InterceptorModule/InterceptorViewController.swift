...
class InterceptorViewController: UIViewController, Routable {
    ...
    @objc private func authInterceptorTapped() {
        Router.shared.navigate(to: "/InterceptorModule/auth", parameters: [
    ...
    @objc private func loggingTapped() {
        Router.shared.navigate(to: "/InterceptorModule/logging", parameters: [
            "source": "interceptorMain",
            "timestamp": Date().timeIntervalSince1970
        ], completion: { _ in })
    }
    ...
    @objc private func performanceTapped() {
        Router.shared.navigate(to: "/InterceptorModule/performance", parameters: [
            "source": "interceptorMain",
            "timestamp": Date().timeIntervalSince1970
        ], completion: { _ in })
    }
    ...
    @objc private func securityTapped() {
        Router.shared.navigate(to: "/InterceptorModule/security", parameters: [
            "source": "interceptorMain",
            "timestamp": Date().timeIntervalSince1970
        ], completion: { _ in })
    }
    ...
    @objc private func cacheTapped() {
        Router.shared.navigate(to: "/InterceptorModule/cache", parameters: [
            "source": "interceptorMain",
            "timestamp": Date().timeIntervalSince1970
        ], completion: { _ in })
    }
    ...
    @objc private func chainTapped() {
        Router.shared.navigate(to: "/InterceptorModule/chain", parameters: [
            "source": "interceptorMain",
            "timestamp": Date().timeIntervalSince1970
        ], completion: { _ in })
    }
