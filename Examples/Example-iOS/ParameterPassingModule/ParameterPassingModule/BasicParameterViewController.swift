...
class BasicParameterViewController: UIViewController, Routable {
    ...
    private func testStringParameter() {
        let parameters = [
    ...
    private func testNumberParameter() {
    ...
    private func testBooleanParameter() {
        let parameters: [String: Any] = [
            "isVIP": true,
    ...
    private func testMultipleParameters() {
        let parameters: [String: Any] = [
            "name": "张三",
            "age": 25,
            "isStudent": true,
    ...
    private func testArrayParameter() {
        let parameters: [String: Any] = [
    ...
    private func testDictionaryParameter() {
        let parameters: [String: Any] = [
            "userInfo": [
                "id": 123,
                "name": "李四",
    ...
    private func testNestedDataParameter() {
        let parameters: [String: Any] = [
            "company": [
                "name": "科技公司",
                "employees": [
    ...
    private func testMixedParameters() {
